...
<div class="{{$col_class}} amount-received-field @if($payment_line['method'] != 'cash') hide @endif">
	<div class="form-group">
		{!! Form::label("amount_received_$row_index" ,__('lang_v1.amount_received') . ':') !!}
		<div class="input-group">
			<span class="input-group-addon">
				<i class="fas fa-money-bill-wave"></i>
			</span>
			{!! Form::text("payment[$row_index][amount_received]", @num_format($payment_line['amount_received'] ?? 0), ['class' => 'form-control amount-received input_number', 'id' => "amount_received_$row_index", 'placeholder' => __('lang_v1.amount_received')]); !!}
		</div>
	</div>
</div>
