...
// Custom Receipt Module Routes
Route::middleware(['auth', 'setData'])->group(function () {
    Route::prefix('custom-receipt')->group(function () {
        Route::get('/', [\Modules\CustomReceipt\Http\Controllers\CustomReceiptController::class, 'index'])->name('custom-receipt.index');
        Route::get('/generate/{id}', [\Modules\CustomReceipt\Http\Controllers\CustomReceiptController::class, 'generateReceipt'])->name('custom-receipt.generate');
        Route::get('/print/{id}', [\Modules\CustomReceipt\Http\Controllers\CustomReceiptController::class, 'printReceipt'])->name('custom-receipt.print');
    });
});
