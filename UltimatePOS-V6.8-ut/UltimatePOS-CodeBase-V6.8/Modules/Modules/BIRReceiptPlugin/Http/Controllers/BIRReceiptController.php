...
class BIRReceiptController extends Controller
{
    ...
    public function generateReceipt(Request $request)
    {
        ...
        $receiptData = $this->prepareReceiptData($transactionId, $settings, $template, $customization);
     ...
     */
    private function prepareReceiptData($transactionId, $settings, $template, $customization = null)
    {
        // This is a placeholder - in real implementation, you would fetch transaction data
        // from your POS system or database
        return [
    ...
    private function generatePDF($receiptData, $template, $customization)
    {
        ...
        $pdf = Pdf::loadView($view, $receiptData);
