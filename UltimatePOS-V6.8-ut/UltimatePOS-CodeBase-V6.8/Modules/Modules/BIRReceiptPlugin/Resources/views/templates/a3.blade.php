...
<head>
    ...
    <title>BIR Cash Invoice - {{ $receiptData['receipt_number'] }}</title>
    <style>
        @page {
            size: 80mm auto;
            margin: 0;
...
<body>
    <div class="receipt">
        ...
        <!-- Receipt Title -->
        <div class="receipt-title">Cash Invoice</div>
        
        <!-- Receipt Information -->
        <div class="receipt-info">
            <table>
                <tr>
                    <td class="text-left">CI No.:</td>
                ...
                <tr>
                    ...
                    <td class="text-right">{{ $receiptData['transaction']['customer_name'] }}</td>
                </tr>
            </table>
        </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <div>Cash payment received with thanks!</div>
            <div class="bir-notice">
                This cash invoice is issued in compliance with BIR RMC No. 77-2024
            </div>
        </div>
    </div>
</body>
